...
async def analyze_product(
    ...
    try:
        ...
        # Convert is_halal to string if it's boolean
        is_halal_str = analysis_result["is_halal"]
        if isinstance(is_halal_str, bool):
            is_halal_str = "true" if is_halal_str else "false"
        ...
        product_check = ProductCheck(
            ...
            is_edible=analysis_result["is_edible"],
